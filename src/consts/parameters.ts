...
export const clientIdConst = import.meta.env.VITE_THIRDWEB_API_KEY || "";
export const factoryAddressConst = import.meta.env.VITE_CREST_SMARTWALLET_FACTORY_ADDRESS || "";
